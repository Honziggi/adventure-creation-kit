...
val modid = "adventure_creation_kit"
...
dependencies {
    ...
    //implementation(files("libs/the_hyrule_fantasy-alpha-1.0.1-forge-1.20.1.jar"))
}
...
mixin.run {
    add(sourceSets.main.get(), "adventure_creation_kit.mixins.refmap.json")
    config("adventure_creation_kit.mixins.json")
